...
import BaseTabbar from './Compent/BaseTabbar';
...
//     });
//   if (action.key ==='MarkView'&& (access_token==''||access_token==undefined)) { 
      
//     this.routes = [ 
//     //   ...state.routes, 
//       {key: 'id-'+Date.now(), routeName: 'LoginView'}, 
//     ]; 
//     return { 
//       ...state, 
//       routes, 
...
export default class UCOINApp extends Component { 
...
AppRegistry.registerComponent('UCOIN', () => App);
